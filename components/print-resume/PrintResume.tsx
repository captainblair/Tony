...
const EXPERIENCE = [
    {
        ...
        duties: [
            'Led the engineering of a centralized university digital registration platform built with PHP and Laravel, delivering responsive, role-aware interfaces and multi-step registration workflows that supported secure onboarding of 800+ active student records with zero downtime.',
