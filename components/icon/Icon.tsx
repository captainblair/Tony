        ...
        case 'social':
            return (
                <svg viewBox='-2 -2 28 28'>
                    <path
                        fillRule='evenodd'
                        d='M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zM15 11.25c1.245 0 2.243-1.005 2.243-2.25S16.245 6.75 15 6.75c-1.245 0-2.25 1.005-2.25 2.25s1.005 2.25 2.25 2.25zm-6 0c1.245 0 2.243-1.005 2.243-2.25S10.245 6.75 9 6.75C7.755 6.75 6.75 7.755 6.75 9s1.005 2.25 2.25 2.25zm0 1.5c-1.748 0-5.25 0.878-5.25 2.625V17.25h10.5v-1.875c0-1.748-3.503-2.625-5.25-2.625zm6 0c-.217 0-.465.015-.728.038.87.63 1.478 1.478 1.478 2.588V17.25h4.5v-1.875c0-1.748-3.503-2.625-5.25-2.625z'
                    />
                </svg>
            )
